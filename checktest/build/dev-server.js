...
app.post('/service/getSubItemsByMainItemId.action', function (req, response) {
  request.post(baseUrl+req.url,{
    form:req.body
  },function(error,res,data){
    response.send(data);
...
app.post('/service/getDeptsAndDbViewShops.action', function (req, response) {
 request.post(baseUrl+req.url,{
 form:req.body
 },function(error,res,data){
 response.send(data);
...
app.post('/service/saveCheckTaskForWebView.action', function (req, response) {
...
app.post('/service/deleteCheckTaskById.action', function (req, response) {
  console.log(req.body);
  request.post(baseUrl+req.url,{
    form:req.body
  },function(error,res,data){
