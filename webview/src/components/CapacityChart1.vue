        ...
        <div class="report-content-inner">
            <div class="board-box">
                <div class="board-cell">
                    <span class="cell-tip" id="help11"><span v-i18n="{value:'common.total'}"></span><span class="moon-ico icon-info"></span></span>
                ...
                <div class="board-cell">
                    <span class="cell-tip"id="help12"><span v-i18n="{value:'checkreport.passcountmonth'}"></span><span class="moon-ico icon-info"></span></span>
            ...
            <div class="chart-box">
                <div v-show="!display.nodata" id="capacityChart1" v-bind:style="{width:chart.width+'px'}" class="chart-container"></div>
                <div v-show="display.nodata" id="nodataChart11" class="no-data" v-bind:style="{width:chart.width+'px',height:'360px'}" class="chart-container"></div>
            </div>
            <div class="data-list">
                <ul>
...
<script>
    ...
    module.exports = {
        ...
        methods:{
            init:function(){
                bindTouchStart('help11','.help11');
                bindTouchEnd('help11','.help11');
                bindTouchStart('help12','.help12');
                bindTouchEnd('help12','.help12');
                $('#contentList .infinite-scroll-preloader').hide();
            },
            initChart:function(){
                var _this = this;
                var myChart = echarts.init(document.getElementById('capacityChart1'));
                myChart.showLoading();
            ...
            getManagerData:function(){
                ...
                this.$http.post('/service/getManagerTotalReport.action',{
            ...
            renderNodataChart:function(){
                var myChart = echarts.init(document.getElementById('nodataChart11'));
