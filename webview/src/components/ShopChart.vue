  ...
  <div>
    <div class="board-box">
      <div class="board-cell">
        <span class="cell-tip" id="help0"><span v-i18n="{value:'checkreport.storenums'}"></span><span class="moon-ico icon-info"></span></span>
      ...
      <div class="board-cell">
        <span class="cell-tip" id="help1"><span v-i18n="{value:'checkreport.coverstore'}"></span><span class="moon-ico icon-info"></span></span>
      ...
      <div class="boardbox-splitor"></div>
      <div class="board-cell">
        <span class="cell-tip" id="help2"><span v-i18n="{value:'checkreport.passstorenum'}"></span><span class="moon-ico icon-info"></span></span>
