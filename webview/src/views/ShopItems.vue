      ...
      <div class="nav-content">
        ...
        <div class="tab-panel bar bar-nav">
          <div class="buttons-tab head-tab">
            <a v-on:click="showAll(1)" class="tab-link  button" v-bind:class="display.showall?'active':''">所有检查项</a>
            <a v-on:click="showAll(0)" class="tab-link button" v-bind:class="!display.showall?'active':''">不合格点检项</a>
          </div>
        </div>
      </div>
